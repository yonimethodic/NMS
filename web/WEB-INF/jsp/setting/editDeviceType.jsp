                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Edit Device Type</h3>
                                </div><!-- /.box-header -->
                                <c:url var="devicetypeAction" value="/devicetype/update" ></c:url>
                                <f:form action="${devicetypeAction}" commandName="devicetype" method="post" role="form" data-toggle="validator">
                                    <div class="box-body">                                    
                                        <div class="row margin">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="hidden" name="id" id="devicetypeId" value="<c:out value="${devicetype.id}" />">
                                                    <label for="txtFirstName">Type Name</label>
                                                    <input type="text" class="form-control" name="txtTypeName" value="<c:out value="${devicetype.typeName}" />" id="txtTypeName" placeholder="Enter Type Name">
                                                </div>
