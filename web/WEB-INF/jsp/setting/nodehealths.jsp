...
<html>
    ...
    <body class="skin-blue">
                        ...
                        <div class="col-xs-12">                            
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">Node Health Statistics </h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body pad" style="text-align: right;">
                                    <div id="NodeHealthGridContainer" style="width: 100%;">
                                        <table id="nodehealthsGrid"></table>
        ...
        <script type="text/javascript">
            jQuery("#nodehealthsGrid").jqGrid({
                url: '/EPMS/nodehealth/nodehealthsGrid',
                datatype: 'json',
                mtype: 'GET',
                colNames: ['Id', 'logDate','Lat','Long','Batery Status','Network Signal Strength'],
                colModel: [
                    {name: 'id', index: 'id', hidden: true},
                    {name: 'logDate', index: 'logDate'},
                    {name: 'lat', index: 'lat'},
                    {name: 'long1', index: 'long1'},
                    {name: 'batteryStatus', index: 'batteryStatus'},
                    {name: 'networkSignalStrength', index: 'networkSignalStrength'}
                ...
                viewrecords: true,
                sortorder: 'desc',
                caption: 'Node Health Statistics Grid'
            });
            jQuery("#nodehealthsGrid").jqGrid('navGrid', '#pager2', {edit: false, add: false, del: false, search: true});
              jQuery(document).ready(function() {
                     
                var width = $('#NodeHealthGridContainer').width();
                jQuery('#nodehealthsGrid').setGridWidth(width, true);
            });
